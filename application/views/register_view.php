							...
							<div class="contact-form contact-form-inputs-filled contact-form-button-circle">
								<form action="assets/php/mailer.php" method="post" novalidate="novalidate">
									<div class="row">
										...
										<div class="col-md-12">
											<input class="bg-athens-gray px-4" type="text" name="email" aria-required="true" aria-invalid="false" placeholder="Email" required>
										</div><!-- /.col-md-12 -->
										<div class="col-md-12">
										...
										<div class="col-md-12">
											<input type="submit" value="SIGN UP" class="font-size-14 ltr-sp-1">
										</div><!-- /.col-md-12 -->
										<div class="col-md-12 mt-4">
											<p class="font-size-12 lh-15">By signing up, you agree to Tumbas's <a>Term of Services</a> and have read Tumbas's <a>Privacy Policy</a></p>
											<hr>
											<p class="font-size-12">Already have Tumbas's account? <a href="<?php echo base_url(); ?>general/login">Sign In</a></p>
										</div>
									</div><!-- /.row -->
								</form>
